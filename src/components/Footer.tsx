...
export default function Footer() {
    return (
        <footer className="w-full bg-[#272624] text-[#EAE4D9] py-24 px-8 sm:px-16 lg:px-28 border-t-0">
            <div className="max-w-5xl mx-auto flex flex-col items-center justify-center gap-16">
                
                {/* Centered Logo */}
                <div className="relative w-40 h-14 md:w-56 md:h-20 opacity-90 transition-opacity hover:opacity-100 duration-700">
                    <Image 
            ...
            {/* Copyright & Legal */}
            <div className="max-w-5xl mx-auto mt-20 pt-8 border-t border-[#EAE4D9]/10 flex flex-col md:flex-row justify-between items-center text-[10px] md:text-[11px] uppercase tracking-widest text-[#EAE4D9]/40 font-medium">
